...
<form method="post">
    ...
    <div class="mb-3">
              ...
              <textarea id="descricao" name="descricao" class="form-control" rows="4" required=""><?= $produto['deescricao']?></textarea>
            </div><div class="mb-3">
              ...
              <select id="categoria" name="categoria" class="form-select" required="">
                <?php foreach ($categorias as $a): ?>
                    <option value="<?= $a['id']?>" <?= $a['id'] == $produto['categoria_id'] ? "selected" : "" ?> <?= $a['nome']?> </option>
                <?php endforeach; ?>
              </select>
            </div>
