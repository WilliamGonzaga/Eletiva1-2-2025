...
<body>
    <div class="container">
        <h3 class="text-center">3 - Criar um formulário que permita ao usuário inserir dois números. O script PHP deve multiplicar esses números e exibir o resultado.</h3>
        ...
        <form method="post">
            ...
            <div class="mb-3 mt-3">
                <label for="soma" class="form-label">Resultado da Multiplicação: </label>
                <?php
