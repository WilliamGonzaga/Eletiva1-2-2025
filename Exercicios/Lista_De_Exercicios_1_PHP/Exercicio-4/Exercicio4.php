...
<body>
    <div class="container">
        <h3 class="text-center">4 - Criar um formulário que permita ao usuário inserir dois números. O script PHP deve dividir o primeiro número pelo segundo e exibir o resultado. Inclua uma verificação para evitar divisão por zero</h3>
        ...
        <form method="post">
            ...
            <div class="mb-3 mt-3">
                <label for="soma" class="form-label">Resultado da divisão: </label>
                <?php
