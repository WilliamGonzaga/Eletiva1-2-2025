...
<body>
    <div class="container">
        <h3 class="text-center">17 -  Crie um formulário que permita ao usuário inserir um capital, uma taxa de juros e um período. O script PHP deve calcular os juros simples (capital * taxa * período) e exibir o resultado. </h3>
